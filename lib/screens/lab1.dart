...
class _LabOne extends State<Lab1> {
  ...
  void updateData(String item, bool isClicked) async {
    if (!isClicked) {
      ...
      var timedef =
          await Firestore.instance.collection('Lab1').document('$item').get();
  ...
  void getdata() async {
    try {
      ...
      var tkdata = await Firestore.instance
          .collection('Lab1')
          .document('TrainerKit')
          .get();
      setState(() {
  ...
  void openUpdate(bool isOpen) async {
    if (isOpen) {
      ...
      var usermin = await Firestore.instance
          ...
          .document('${user.email}')
          .get();
      int userminutes = usermin.data['lab1util'];
      await Firestore.instance
          .collection('users')
          .document('${user.email}')
          .updateData({
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            InkWell(
                              ...
                              child: Lab1Equipment(
                                  eq1name: 'CRO 1', colour: button1Color),
                            ),
                            SizedBox(height: 25),
                            InkWell(
                              onTap: () {
                              ...
                              child: Lab1Equipment(
                                  eq1name: 'CRO 2', colour: button2Color),
                            ),
                            SizedBox(height: 25),
                            InkWell(
                              onTap: () {
                              ...
                              child: Lab1Equipment(
                                  eq1name: 'DMM 1', colour: button3Color),
                            ),
                            SizedBox(height: 25),
                            InkWell(
                              onTap: () {
                              ...
                              child: Lab1Equipment(
                                  eq1name: 'DMM 2', colour: button4Color),
                            ),
                            SizedBox(height: 25),
                            InkWell(
                              onTap: () {
