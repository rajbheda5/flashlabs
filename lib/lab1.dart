              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  InkWell(
                    ...
                    child: Lab1Equipment(eq1name: 'CRO 1',colour: button1Color),
                  ),
                  SizedBox(height: 25),
                  InkWell(
                    onTap: (){
                    ...
                    child: Lab1Equipment(eq1name: 'CRO 2',colour: button2Color),
                  ),
                  SizedBox(height: 25),
                  InkWell(
                    onTap: (){
                    ...
                    child: Lab1Equipment(eq1name: 'DMM 1',colour: button3Color),
                  ),
                  SizedBox(height: 25),
                  InkWell(
                    onTap: (){
                    ...
                    child: Lab1Equipment(eq1name: 'DMM 2',colour: button4Color),
                  ),
                  SizedBox(height: 25),
                  InkWell(
                    onTap: (){
